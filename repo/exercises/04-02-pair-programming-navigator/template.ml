...
(* ===== PART ONE =====
   Start by guiding the driver through the implementation of the following function.
   The function should be implemented by recursion on the input list `hand`.
 *)
